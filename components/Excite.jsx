  ...
  return (
    ...
    <div className="relative flex text-white justify-center mt-16 ml-9 gap-6 h-full">
        ...
        <h1 className='uppercase  font-extrabold text-xl mb-5'>New Mentorship Program Launched</h1>
            <h1 className="text-white text-md">
            Freelancers, you asked, and we delivered! Our new mentorship and skills exchange program is here. Connect with industry experts, grow your skills, and expand your network. The perfect opportunity to level up your freelancing game!            </h1>
        ...
        <h1 className='uppercase font-extrabold text-xl mb-5'>Real-Time Performance Scores</h1>
            <h1 className="text-white text-md">
            Get ready to make smarter hiring decisions with Teamify’s real-time performance scores. Track communication, reliability, and project quality in one place. It’s transparency and trust at your fingertips!            </h1>
        ...
        <div className=' relative flex flex-col justify-center gap-10'>
            <div className='relative text-white flex flex-col items-center'>
                ...
                <div className='text-black flex justify-center mb-6'>
                        <button className='bg-[#4FA9E2] p-3  rounded-lg font-extrabold'>Click here</button>
                </div>
        </div>
